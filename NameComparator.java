...
public class NameComparator implements Comparator<Person> {
    ...
    /**
     * Constructor creates a new NameComparator object.
     *
     * @param hashmap HashMap to be sorted.
     */
    public NameComparator(PersonDataHashMap hashmap){
    ...
    /**
     * Sorts information in HashMap in ascending order of Name.
     *
    ...
    /**
     * This method compare two Person object's name.
     *
     * @param o1 Some Person object.
     * @param o2 Some person object.
     *
     * @return 0 if Person 01's name is greater than Person o2, false otherwise.
     */
    @Override
